...
let dis='';
//let intro = ["Hello, I am Rodoc", "Hi, I am a Rodoc", "Hello, My name is Rodoc"];
let intro = ["Hey handsome, I am Rodoc. What can i do for you"];
...
let preventbody=["Use a cold ice pack if you’re in physical pain, if you have swelling, or if the ache is local (e.g. only in your shoulder). Take a hot bath or use a heating pad if the ache is widespread (e.g. in a case of the flu). Also try alternating between hot and cold, each applied for about 10 minutes one after the other."]
...
let preventtyphoid=['Make sure you rest, drink plenty of fluids and eat regular meals. You may find it easier to eat smaller meals more frequently, rather than 3 larger meals a day.']
